    ...
    <div className="flex flex-col gap-6">
      <Card className="overflow-hidden shadow-lg border-0">
        <CardContent className="grid p-0 md:grid-cols-2 min-h-[600px]">
          ...
          <div className="relative hidden bg-gradient-to-br from-green-500 to-green-800 md:flex flex-col gap-y-6 items-center justify-center p-8">
            <div className="text-center space-y-4">
              ...
              />
              <div>
                <h2 className="text-3xl font-bold text-white">SenMeet</h2>
