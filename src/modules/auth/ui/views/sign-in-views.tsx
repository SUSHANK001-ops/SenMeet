          ...
          <CardContent className="grid p-0 md:grid-cols-2 min-h-[600px]">
            <Form {...form}>
              ...
              >
                ...
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-green-200/20 to-blue-200/20 rounded-full blur-3xl"></div>
                <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-br from-blue-200/20 to-purple-200/20 rounded-full blur-2xl"></div>
                ...
                <div className="flex flex-col gap-6 max-w-sm mx-auto w-full relative z-10">
                  ...
                  >
                    <motion.div
                      className="p-3 bg-gradient-to-br from-green-500 to-blue-600 rounded-2xl mb-2"
                            ...
                            <FormControl>
                              ...
                              >
                                <Input
                                  ...
                                  className="h-11 border-2 transition-all duration-300 focus:border-green-500 focus:shadow-lg focus:shadow-green-500/20"
                                  {...field}
                                />
                              </motion.div>
                            </FormControl>
                  ...
                  <motion.div variants={itemVariants}>
                    ...
                    >
                      <Button
                        type="submit"
                        className="w-full h-11 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 shadow-lg hover:shadow-xl transition-all duration-300"
                        disabled={pending}
                      >
                        {pending ? (
                          <motion.div
            ...
            <motion.div
              className="relative hidden bg-gradient-to-br from-green-600 via-blue-600 to-green-800 md:flex flex-col gap-y-6 items-center justify-center p-8 overflow-hidden"
